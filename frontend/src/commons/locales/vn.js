export default {
  ...
  Type: {
    ...
    table: {
      ...
      AREA: 'Thêm mới nhiều loại văn bản',
      AREA_DES: 'Hướng dẫn thêm <b>B</b>',
      FILE: 'Nhập file CSV',
      CHECK_BOX: 'File có tiêu đề',
    },
    form: {
  ...
  Language: {
    NAME: 'Ngôn ngữ văn bản',
    table: {
      _ID: 'id',
      NAME: 'Tên ngôn ngữ văn bản',
      NOTATION: 'Ký hiệu',
      DESCRIPTION: 'Mô tả',
      COLOR: 'Màu hiển thị',
      CREATED_AT: 'Ngày tạo',
    ...
    form: {
      TITLE: 'Nhập thông tin ngôn ngữ văn bản',
      NAME_REQUIRED: 'Tên ngôn ngữ văn bản không được bỏ trống',
      NAME_MAX_LENGTH: 'Tên ngôn ngữ văn bản quá dài (hơn 100 ký tự)',
      NOTATION_REQUIRED: 'Ký hiệu ngôn ngữ văn bản không được bỏ trống',
      NOTATION_MAX_LENGTH: 'Ký hiệu ngôn ngữ văn bản quá dài (hơn 10 ký tự)',
    },
    Id: {
      NAME: 'LANGUAGE_NAME',
      NOTATION: 'LANGUAGE_NOTATION',
