              ...
              <CForm noValidate className="row g-3">
                <CCol xs={12}>
                  ...
                  <CFormInput
                    ...
                    placeholder={Strings.Form.FieldName.NAME(Strings.Priority.NAME)}
                    value={state.name}
                    onChange={(e) => updateState({ name: e.target.value })}
                    onKeyPress={handleKeypress}
                  />
                  <CFormFeedback invalid>
                    {error.name && Strings.Form.Validation[error.name](Strings.Priority.NAME)}
                  </CFormFeedback>
                </CCol>
                <CCol>
                  <CFormLabel
                  ...
                  <CFormInput
                    ...
                    placeholder={Strings.Form.FieldName.COLOR(Strings.Priority.NAME)}
                    value={state.color}
                    onChange={(e) => updateState({ color: e.target.value })}
                    onKeyPress={handleKeypress}
                  />
                  <CFormFeedback invalid>
                    {error.color && Strings.Form.Validation[error.color](Strings.Priority.NAME)}
                  </CFormFeedback>
                </CCol>
                <CCol xs={12}>
                  <CFormLabel
                  ...
                  >
                    {error.description &&
                      Strings.Form.Validation[error.description](Strings.Priority.NAME)}
                  </CFormFeedback>
                </CCol>
              </CForm>
            </CCardBody>
