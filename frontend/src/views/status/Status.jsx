...
import { setData, setPage, setRowPerPage, setTotal } from 'src/store/slice/status.slide'
...
export default function Status() {
  ...
  return (
    <CContainer fluid>
                  ...
                  <CButtonGroup role="group">
                    ...
                    {loggedUser.right[Strings.Common.CREATE_CATEGORIES] && (
                      <CButton
                        color="primary"
                        variant="outline"
                        onClick={() => navigate(Screens.STATUS_CREATE)}
                      >
      ...
      >
        <CModalHeader>
          <CModalTitle>{Strings.Status.NAME}</CModalTitle>
        </CModalHeader>
        <CModalBody>
          <CFormLabel>{Strings.Form.FieldName.CSV(Strings.Status.NAME)}</CFormLabel>
          <CFormTextarea
            rows="3"
            value={add.text}
          ...
          <CFormText component="span">
            <div dangerouslySetInnerHTML={{ __html: Strings.Status.Common.DESCRIPTION }}></div>
          </CFormText>
          <CFormLabel>{Strings.Form.FieldName.FILE_CSV(Strings.Status.NAME)}</CFormLabel>
