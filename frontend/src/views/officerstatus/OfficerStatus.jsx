...
import { setData, setPage, setRowPerPage, setTotal } from 'src/store/slice/officerStatus.slide'
import Swal from 'sweetalert2'
import withReactContent from 'sweetalert2-react-content'
import officerStatusColumns from './officerStatusColumns'
...
export default function OfficerStatus() {
  ...
  const store = useSelector((state) => state.officerStatus)
                  ...
                  <CButtonGroup role="group">
                    ...
                    {loggedUser.right[Strings.Common.CREATE_RIGHT] && (
                      <CButton
                        color="primary"
                        variant="outline"
                        onClick={() => navigate(Screens.OFFICER_STATUS_CREATE)}
                      >
