...
import { setData, setTotal } from 'src/store/slice/officerStatus.slide'
      ...
      {loggedUser.right[Strings.Common.READ_RIGHT] && (
        <CTooltip content={Strings.Common.DETAIL}>
          <CButton
            ...
            className="m-1"
            onClick={() =>
              navigate(Screens.OFFICER_STATUS_DETAIL(`${Helpers.toSlug(data.name)}.${data._id}`))
            }
          >
      ...
      {loggedUser.right[Strings.Common.UPDATE_RIGHT] && (
        <CTooltip content={Strings.Common.EDIT}>
          <CButton
            ...
            className="m-1"
            onClick={() =>
              navigate(Screens.OFFICER_STATUS_UPDATE(`${Helpers.toSlug(data.name)}.${data._id}`))
            }
          >
